...
# token        tok_…                        (file or env)
#                                           ↑ (unset) だと publish できない
```
...
- `http://100.x.x.x:8765/` — 全パッケージ一覧。Name / Tag /
  Description の regex 検索フォーム + Tags 列
- `http://100.x.x.x:8765/packages/my-skill` — version 一覧に
  **published_at / published_by / zip ダウンロード**
...
# {
#   "entries": [
#     {"raw": "2026-04-15T10:23:45Z  alice   my-skill  0.1.0 (new)", ...}
#   ], ...
# }
```
